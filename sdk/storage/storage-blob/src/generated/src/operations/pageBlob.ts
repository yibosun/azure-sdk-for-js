...
export class PageBlob {
  ...
  /**
   * The Get Page Ranges operation returns the list of valid page ranges for a page blob, version or
   ...
   * blob that were changed between target blob/snapshot/version and previous snapshot.
   * @param [options] The optional parameters
