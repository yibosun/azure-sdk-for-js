...
export class Service {
  ...
  /**
   * The Filter Blobs operation enables callers to list blobs in an account whose tags match a given
   * search expression.
   * @param [options] The optional parameters
   ...
   * @param callback The callback
   */
  filterBlobs(callback: msRest.ServiceCallback<Models.FilterBlobsResponse>): void;
  /**
   * @param options The optional parameters
   * @param callback The callback
   */
  filterBlobs(options: Models.ServiceFilterBlobsOptionalParams, callback: msRest.ServiceCallback<Models.FilterBlobsResponse>): void;
  filterBlobs(options?: Models.ServiceFilterBlobsOptionalParams | msRest.ServiceCallback<Models.FilterBlobsResponse>, callback?: msRest.ServiceCallback<Models.FilterBlobsResponse>): Promise<Models.ServiceFilterBlobsResponse> {
    return this.client.sendOperationRequest(
      {
        options
      },
...
const filterBlobsOperationSpec: msRest.OperationSpec = {
  httpMethod: "GET",
  urlParameters: [
    Parameters.url
  ],
  ...
  responses: {
    200: {
      bodyMapper: Mappers.FilterBlobsResponse,
