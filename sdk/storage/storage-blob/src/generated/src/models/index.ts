...
export interface BlobProperties {
  ...
  customerProvidedKeyName?: string;
...
/**
 * An interface representing FilterBlobsItem.
 */
export interface FilterBlobsItem {
  name?: string;
  containerName?: string;
  tagValue?: string;
}
...
/**
 * An interface representing FilterBlobsSegment.
 */
export interface FilterBlobsSegment {
  blobItems?: FilterBlobsItem[];
}

/**
 * An enumeration of blobs which matched the filter.
 */
export interface FilterBlobsResponse {
  serviceEndpoint: string;
  filter: string;
  marker?: string;
  maxResults?: number;
  segment: FilterBlobsSegment;
  nextMarker: string;
}
 ...
 * Additional parameters for a set of operations.
 */
export interface CustomerProvidedKeyInfo {
  /**
   * Optional. Specifies the name of the encryption key to use to encrypt the data provided in the
   * request. If not specified, encryption is performed with the root account encryption key.  For
...
export interface ServiceListContainersSegmentOptionalParams extends msRest.RequestOptionsBase {
   ...
   * response body. Possible values include: 'deleted', 'metadata'
   */
 ...
 * Optional Parameters.
 */
export interface ServiceFilterBlobsOptionalParams extends msRest.RequestOptionsBase {
  /**
   * A string value that identifies the portion of the list of containers to be returned with the
   * next listing operation. The operation returns the NextMarker value within the response body if
   * the listing operation did not return all containers remaining to be listed with the current
...
export interface BlobDownloadOptionalParams extends msRest.RequestOptionsBase {
  ...
  snapshot?: string;
  /**
   * The version ID parameter is an opaque DateTime value that, when present, specifies the blob
   * version to retrieve.
   */
  versionId?: string;
  /**
...
export interface BlobSetMetadataOptionalParams extends msRest.RequestOptionsBase {
   ...
   * Additional parameters for the operation
   */
  customerProvidedKeyInfo?: CustomerProvidedKeyInfo;
  /**
   * Additional parameters for the operation
   */
  modifiedAccessConditions?: ModifiedAccessConditions;
...
export interface BlobStartCopyFromURLOptionalParams extends msRest.RequestOptionsBase {
  ...
  metadata?: { [propertyName: string]: string };
  /**
   * Optional. A URL encoded query param string which specifies the tags to be created with the
   * Blob object. e.g. TagName1=TagValue1&TagName2=TagValue2. The x-ms-tags header may contain up
   * to 2kb of tags.
   */
  tags?: string;
  /**
 ...
 * Optional Parameters.
 */
export interface BlobSetTagsOptionalParams extends msRest.RequestOptionsBase {
  /**
   * The timeout parameter is expressed in seconds. For more information, see <a
   * href="https://docs.microsoft.com/en-us/rest/api/storageservices/fileservices/setting-timeouts-for-blob-service-operations">Setting
   * Timeouts for Blob Service Operations.</a>
 ...
 * Optional Parameters.
 */
export interface BlobGetTagsOptionalParams extends msRest.RequestOptionsBase {
  /**
   * The timeout parameter is expressed in seconds. For more information, see <a
   * href="https://docs.microsoft.com/en-us/rest/api/storageservices/fileservices/setting-timeouts-for-blob-service-operations">Setting
   * Timeouts for Blob Service Operations.</a>
...
export interface PageBlobGetPageRangesDiffOptionalParams extends msRest.RequestOptionsBase {
  ...
  prevsnapshot?: string;
  /**
   * Optional in version 2019-04-04 and newer. The prevsnapshoturl header is an url that specifies
   * that the response will contain only pages that were changed between target blob and previous
   * snapshot. Changed pages include both updated and cleared pages. The target blob may be a
   * snapshot or version id, as long as the snapshot specified by prevsnapshoturl is the older of
   * the two.
   */
...
export interface ServiceFilterBlobsHeaders {
  /**
   * The media type of the body of the response. For Filter Blobs this is 'application/xml'
   */
  contentType?: string;
  /**
   * If a client request id header is sent in the request, this header will be present in the
...
export interface BlobDownloadHeaders {
  ...
  /**
   * The name of the encryption key used to encrypt the blob. This header is only returned when the
   * blob was encrypted with a customer-provided key.
   */
  encryptionKeyName?: string;
  /**
...
export interface BlobGetPropertiesHeaders {
  ...
  encryptionKeySha256?: string;
  /**
   * The name of the encryption key used to encrypt the metadata. This header is only returned when
   * the metadata was encrypted with a customer-provided key.
   */
  encryptionKeyName?: string;
  /**
...
export interface PageBlobCreateHeaders {
  ...
  version?: string;
  /**
   * UTC date/time value generated by the service that identifies a version of the blob. This
   * header is returned for requests made against version 2018-11-09 and above.
   */
  versionId?: string;
  /**
   * UTC date/time value generated by the service that indicates the time at which the response was
...
export interface BlobCreateSnapshotHeaders {
  ...
  version?: string;
  /**
   * UTC date/time value generated by the service that identifies the version of the blob. This
   * header is returned for requests made against version 2018-11-09 and above.
   */
  versionId?: string;
  /**
  ...
  encryptionKeySha256?: string;
  /**
   * The name of the encryption key used to encrypt the source blob. This header is only returned
   * when the blob was encrypted with a customer-provided key.
   */
  encryptionKeyName?: string;
  errorCode?: string;
...
export interface BlockBlobStageBlockHeaders {
  ...
  encryptionKeySha256?: string;
  /**
   * The name of the encryption key used to encrypt the block. This header is only returned when
   * the block was encrypted with a customer-provided key.
   */
  encryptionKeyName?: string;
  errorCode?: string;
}
...
export interface PageBlobUploadPagesHeaders {
  ...
  encryptionKeySha256?: string;
  /**
   * The name of the encryption key used to encrypt the pages. This header is only returned when
   * the pages were encrypted with a customer-provided key.
   */
  encryptionKeyName?: string;
  errorCode?: string;
}
 ...
 * 'ConcurrentContainerOperationInProgress', 'DeletedContainerNotFound',
 ...
 * Possible values include: 'copy', 'deleted', 'metadata', 'snapshots', 'tags', 'uncommittedblobs'
 * @readonly
 * @enum {string}
 */
export type ListBlobsIncludeItem = 'copy' | 'deleted' | 'metadata' | 'snapshots' | 'tags' | 'uncommittedblobs';

/**
 * Defines values for ListContainersIncludeType.
 * Possible values include: 'deleted', 'metadata'
 * @readonly
 * @enum {string}
 */
export type ListContainersIncludeType = 'deleted' | 'metadata';
 ...
 */
export type ServiceFilterBlobsResponse = FilterBlobsResponse & ServiceFilterBlobsHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: FilterBlobsResponse;
    };
};
